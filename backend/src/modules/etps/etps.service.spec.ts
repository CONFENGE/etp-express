...
describe('EtpsService', () => {
  ...
  describe('create', () => {
    it('should create a new ETP with default values', async () => {
      ...
      const result = await service.create(createDto, mockUser1Id);
  ...
  describe('findAll', () => {
    ...
    it('should filter ETPs by userId when provided', async () => {
      ...
      await service.findAll(paginationDto, mockUser1Id);
  ...
  describe('findOne', () => {
    it('should return ETP with all relations', async () => {
      ...
      const result = await service.findOne('etp-123');
    ...
    it('should not log warning when user accesses own ETP', async () => {
      ...
      await service.findOne('etp-123', mockUser1Id);
  ...
  describe('update', () => {
    it('should update ETP when user is owner', async () => {
      ...
      const result = await service.update('etp-123', updateDto, mockUser1Id);
    ...
    it('should throw ForbiddenException when user is not owner', async () => {
      ...
      await expect(
        service.update('etp-123', updateDto, mockUser2Id),
    ...
    it('should throw NotFoundException when ETP does not exist', async () => {
      ...
      await expect(
        service.update('non-existent', {}, mockUser1Id),
  ...
  describe('updateStatus', () => {
    ...
    it('should throw ForbiddenException when user is not owner', async () => {
      ...
      await expect(
        service.updateStatus('etp-123', EtpStatus.IN_PROGRESS, mockUser2Id),
      ).rejects.toThrow(ForbiddenException);
      await expect(
        service.updateStatus('etp-123', EtpStatus.IN_PROGRESS, mockUser2Id),
      ).rejects.toThrow(
  ...
  describe('remove', () => {
    it('should delete ETP when user is owner', async () => {
      ...
      await service.remove('etp-123', mockUser1Id);
    ...
    it('should throw ForbiddenException when user is not owner', async () => {
      ...
      await expect(service.remove('etp-123', mockUser2Id)).rejects.toThrow(
        ForbiddenException,
      );
      await expect(service.remove('etp-123', mockUser2Id)).rejects.toThrow(
    ...
    it('should throw NotFoundException when ETP does not exist', async () => {
      ...
      await expect(service.remove('non-existent', mockUser1Id)).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('getStatistics', () => {
    ...
    it('should filter statistics by userId when provided', async () => {
      ...
      const result = await service.getStatistics(mockUser1Id);
