 ...
 *
 * Usage:
 * - Development: npm run seed:admin
 * - Production: npm run seed:admin:prod
 *
...
const DEMO_DATA = {
  ...
  authorizedDomain: {
    ...
    institutionName: 'Demonstracao ETP Express',
    maxUsers: 1,
    isActive: true,
  },
};
...
async function createAdminUser(
  ...
  if (adminOrg) {
    ...
    console.log('Admin organization already exists. Skipping creation.');
  } else {
  ...
  if (adminDomain) {
    ...
    console.log('Admin authorized domain already exists. Skipping creation.');
  } else {
...
async function createDemoUser(
  ...
  if (demoDomain) {
    domainStatus = 'Already exists (skipped)';
    console.log('Demo authorized domain already exists. Skipping creation.');
  } else {
