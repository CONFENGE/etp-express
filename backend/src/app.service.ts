...
export class AppService {
  getHealth() {
    return {
      ...
      warning: '⚠️ O ETP Express pode cometer erros. Lembre-se de verificar todas as informações antes de realizar qualquer encaminhamento.',
  ...
  getInfo() {
    return {
      name: 'ETP Express',
      version: '1.0.0',
      description: 'Sistema assistivo para elaboração de Estudos Técnicos Preliminares (Lei 14.133/2021)',
      warning: '⚠️ O ETP Express pode cometer erros. Lembre-se de verificar todas as informações antes de realizar qualquer encaminhamento.',
      features: [
