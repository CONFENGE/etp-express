...
- [ ] Body parser configurado via API nativa do NestJS (sem `require('body-parser')`)
- [ ] Dependencia `body-parser` removida do `package.json` (ou justificada se necessaria)
- [ ] Documentacao `docs/architecture/guards-and-auth.md` criada com fluxo de guards
- [ ] Auditoria de `@Public()` realizada — lista de rotas publicas documentada
- [ ] Feature flags: defaults extraidos para arquivo de configuracao separado
- [ ] Feature flags: log de auditoria implementado em mudancas de flags
- [ ] Feature flags: documentacao operacional criada
- [ ] Chaos module: arquivos avaliados e documentados/movidos conforme padrao
- [ ] Chaos module: protecao contra import acidental em producao verificada
- [ ] Todos os testes passam (`npm test`)
- [ ] Build de producao funciona normalmente (`npm run build`)
- [ ] Nenhuma regressao em rotas publicas ou autenticadas
