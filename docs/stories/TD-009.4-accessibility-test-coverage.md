...
- [x] Dependencia `@axe-core/playwright` instalada e configurada
- [x] Suite de testes E2E de acessibilidade criada em `e2e/accessibility/`
- [x] Todas as ~30 paginas publicas e autenticadas cobertas por scan axe-core
- [x] Regras WCAG 2.1 AA configuradas como baseline minimo
- [x] Violacoes criticas (level A) fazem o teste falhar
- [x] Violacoes moderadas (level AA) sao reportadas como warnings
- [x] Relatorio de acessibilidade gerado automaticamente (HTML ou JSON)
- [x] Testes integrados no pipeline CI (rodam em `npm run test:e2e`)
- [x] Documentacao de como interpretar resultados e corrigir violacoes
- [x] Nenhuma violacao critica nova introduzida (baseline limpo)
