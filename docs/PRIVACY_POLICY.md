...
**Sanitização:** Antes de enviar conteúdo para APIs de IA (OpenAI, Perplexity), **todos os dados pessoais identificáveis são automaticamente removidos** (CPF, CNPJ, e-mails, telefones, etc.) via `PIIRedactionService`.
...
Disponível em: [https://etpexpress.com.br/privacy/request](https://etpexpress.com.br/privacy/request) *(em desenvolvimento)*
...
| **Perplexity** | Estados Unidos | DPA conforme GDPR/LGPD + PII Redaction |
...
**Formulário Online:** [https://etpexpress.com.br/privacy/contact](https://etpexpress.com.br/privacy/contact) *(em desenvolvimento)*
