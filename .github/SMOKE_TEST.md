...
```bash
curl https://etp-express-backend-production.up.railway.app/api/health
```
...
- [ ] Acessar https://etp-express-frontend-production.up.railway.app
- [ ] Página carrega <3s
...
```bash
curl -w "@curl-format.txt" -o /dev/null -s https://etp-express-backend-production.up.railway.app/api/health
```
