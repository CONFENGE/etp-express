...
- ⚠ **100 VUs:** Circuit breakers may open (Perplexity first)
- ⚠ **200 VUs:** High error rate (50%+), circuit breakers open, system degraded
...
| -------- | --- | -------- | ----------- | ---------- | -------- |
| Baseline | 10 | 5 min | XX s | X% | ✅/⚠/❌ |
| Normal | 50 | 10 min | XX s | X% | ✅/⚠/❌ |
| Stress | 100 | 15 min | XX s | X% | ✅/⚠/❌ |
| Breaking | 200 | 10 min | XX s | X% | ✅/⚠/❌ |
