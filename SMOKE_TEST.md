...
| -------------- | -------------- | -------------- | ------- |
| Backend Health | ⚠ PARCIAL | 2/4 | 50% |
| Frontend | ✅ PASSOU | 3/4 | 75% |
| Integracao | ❌ FALHOU | 0/4 | 0% |
| **Total** | **⚠ PARCIAL** | **5/12** | **42%** |
...
| ---------- | --------- | --------------------------- | ----------------- |
| Migrations | Aplicadas | Sem endpoint para verificar | ⚠ NAO VERIFICADO |
...
| Redis/BullMQ | Conectado | Nao verificado diretamente | ⚠ NAO VERIFICADO |
...
| Servico | Esperado | Resultado | Status |
| -------------- | ----------- | --------------- | ---------- |
| Sentry Backend | Configurado | NAO configurado | ⚠ WARNING |
| SMTP Email | Configurado | NAO configurado | ⚠ WARNING |
